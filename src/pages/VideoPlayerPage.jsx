    ...
    <div ref={containerRef} className={styles.pageContainer}>
      <div className={styles.mainCanvas}>
        ...
        <header className={`${styles.playerHeader} player-reveal`}>
          <div>
            <h1 className={styles.videoTitle}>The Chrome Valley <span className={styles.jobBadge}>#{jobId.slice(0, 6)}</span></h1>
          ...
          <div className={styles.headerActions}>
            <button className={styles.iconBtn} aria-label="Share"><span className="material-symbols-outlined">share</span></button>
            <button className={styles.iconBtn} aria-label="Download"><span className="material-symbols-outlined">download</span></button>
          </div>
        </header>
        ...
        {/* Iteration History */}
        <section className={`${styles.historySection} player-reveal`}>
            <div className={styles.historyHeader}>
               <h2>Iteration History</h2>
               <button className={styles.textBtn}>View All Variations</button>
            </div>
            <div className={styles.historyGrid}>
               <div className={`${styles.historyCard} ${styles.activeCard}`}>
                  <img src="https://picsum.photos/seed/v1/400/225" alt="v1" />
                  <span className={styles.verTag}>ACTIVE</span>
               </div>
               <div className={styles.historyCard}>
                  <img src="https://picsum.photos/seed/v2/400/225" alt="v2" />
                  <span className={styles.verTagInner}>V.02</span>
               </div>
               <div className={styles.historyCard}>
                  <img src="https://picsum.photos/seed/v3/400/225" alt="v3" />
                  <span className={styles.verTagInner}>V.01</span>
               </div>
